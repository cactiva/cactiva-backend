...
declare type WrapperFunction = (action: RequestHandler) => any;
...
export declare function Children(middleware: InstanceType<any> | Array<InstanceType<any>>): ClassDecorator;
