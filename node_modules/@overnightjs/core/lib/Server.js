    ...
    Server.prototype.getRouter = function (routerLibrary, controller) {
        ...
        members.forEach(function (member) {
            ...
            if (route && routeProperties) {
                var routeMiddleware = routeProperties.routeMiddleware, httpVerb = routeProperties.httpVerb, path = routeProperties.path, routeWrapper = routeProperties.routeWrapper;
